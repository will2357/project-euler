...
Let  F(N)  be the maximum number of lattice points in an axis-aligned  Nx N  square that the graph of a single strictly convex increasing function can pass through.
