...
Now, assume you have  10  such decks, each with a different back design. We shuffle all  10 x 54  cards together and draw cards without replacement. What is the expected number of cards needed so every suit, rank and deck design have at least one card?
