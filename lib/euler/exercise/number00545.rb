...
Define D(k) as the value of q_1 for the sum of kth powers (i.e. the denominator of the reduced fraction a_1).
Define F(m) as the mth value of k \ge 1 for which D(k) = 20010.
