...
Now we define a hollow square lamina of size  n  to be an integer sized square with side length  n >= 3  consisting of  n^2  unit squares from which a rectangle consisting of  x x y  unit squares ( 1 <= x,y <= n - 2 ) within the original square has been removed.
