...
class Euler::Exercise::Number00597 < Euler::Exercise::Main
...
Suppose that, in a particular race, each boat B_j rows at a steady speed v_j = -logX_j metres per second, where the X_j are chosen randomly (with uniform distribution) between 0 and 1, independently from one another. These speeds are relative to the riverbank: you may disregard the flow of the river.
...
Source: https://projecteuler.net/problem=597
=end
