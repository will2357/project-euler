...
Let  \mathbb{E}(d)  be the expected value of  d  when  r_a ,  r_b  and  r_c  are integers chosen uniformly such that  1<=q r_a<r_b<r_c <=q 100  and  \text{gcd}(r_a,r_b,r_c)=1 .
