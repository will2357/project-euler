...
Given an integer  n ,  n >=q 3 , let  B=\{\mathrm{false},\mathrm{true}\}  and let  B^n  be the set of sequences of  n  values from  B . The function  f  from  B^n  to  B^n  is defined by  f(b_1 ... b_n) = c_1 ... c_n  where:
 c_i = b_{i+1}  for  1 <=q i < n .
