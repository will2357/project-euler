...
Let  n  be a positive integer. Suppose there are stations at the coordinates  (x, y) = (2^i \bmod n, 3^i \bmod n)  for  0 <=q i <=q 2n . We will consider stations with the same coordinates as the same station.
