...
Let  f(n)  represent the number of ways one can fill a  3 x 3 x n  tower with blocks of  2 x 1 x 1 .You're allowed to rotate the blocks in any way you like; however, rotations, reflections etc of the tower itself are counted as distinct.
