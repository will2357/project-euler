...
class Euler::Exercise::Number00716 < Euler::Exercise::Main
...
Consider a directed graph made from an orthogonal lattice of  Hx W  nodes. 
...
There are  2^Hx 2^W  ways of drawing the directed lines. Each way gives a directed graph  \mathcal{G} . We define  S(\mathcal{G})  to be the number of strongly connected components in  \mathcal{G} .
...
Define  C(H,W)  to be the sum of  S(\mathcal{G})  for all possible graphs on a grid of  Hx W . You are given  C(3,3) = 408 ,  C(3,6) = 4696  and  C(10,20) \equiv 988971143 \pmod{1,000,000,007} .
