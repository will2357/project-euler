...
Assuming that the only type of available tatami has dimensions  1 x 2 , there are obviously some limitations for the shape and size of the rooms that can be covered.
...
For example, consider the two arrangements below for a  4 x 4  room:
...
The smallest tatami-free room has size  s = 70  and dimensions  7 x 10 .
All the other rooms of size  s = 70  can be covered with tatami; they are:  1 x 70 ,  2 x 35  and  5 x 14 .
Hence,  T(70) = 1 .

Similarly, we can verify that  T(1320) = 5  because there are exactly  5  tatami-free rooms of size  s = 1320 :
 20 x 66 ,  22 x 60 ,  24 x 55 ,  30 x 44  and  33 x 40 .
