...
Numbering the problems 1, 2, ..., 200, we let s_n be the minimum score of the solution to the nth problem. For example, s_1=40, as the first problem in the file is the example given above. Note that not all problems have a solution; in such cases we take s_n=0.
