...
There are five pairs of integers  a  and  b  ( a <=q b ) such that  a x b=48 :  (1,48) ,  (2,24) ,  (3,16) ,  (4,12)  and  (6,8) .
...
In general:
Let  C(n)  be the number of pairs of positive integers  a x b=n , ( a <=q b ) such that  a  and  b  have the same number of divisors; so  C(48)=1 .
