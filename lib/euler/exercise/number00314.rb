...
Although not allowed , but to get an idea if this is anything better:  if you place a circle inside the square area touching the four sides the area will be equal to  \pi x \pu{250^2 m^2}  and the perimeter will be  \pi x \pu{500 m} , so the enclosed-area/wall-length ratio will also be  125 .
