...
An infinite sequence of real numbers  a(n)  is defined for all integers  n  as follows:
  a(n) = \begin{cases}
1   n < 0 
\sum \limits_{i = 1}^{\infty}{\dfrac{a(n - i)}{i!}}   n >= 0
\end{cases}  

For example,

 a(0) = \dfrac{1}{1!} + \dfrac{1}{2!} + \dfrac{1}{3!} + ... = e - 1 
 a(1) = \dfrac{e - 1}{1!} + \dfrac{1}{2!} + \dfrac{1}{3!} + ... = 2e - 3 
 a(2) = \dfrac{2e - 3}{1!} + \dfrac{e - 1}{2!} + \dfrac{1}{3!} + ... = \dfrac{7}{2}e - 6 
