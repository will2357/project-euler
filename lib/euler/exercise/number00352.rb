...
class Euler::Exercise::Number00352 < Euler::Exercise::Main
...
Consequently, all  5  groups can be screened using an average of only  1.480396016 x 5 = \mathbf{7.40198008}  tests, which represents a huge saving of more than  70\% !
