...
Consider a  16x n  matrix where every entry is either 0 or 1.
Let  B(k,n)  be the total number of these matrices such that the sum of the entries in every  2x k  window is  k .
