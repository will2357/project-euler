...
\begin{align}
\mathrm{checksum}  = 0 
\mathrm{checksum}  = (\mathrm{checksum} x 243 + m_1) \bmod 100,000,007 
\mathrm{checksum}  = (\mathrm{checksum} x 243 + m_2) \bmod 100,000,007 
...   
\mathrm{checksum}  = (\mathrm{checksum} x 243 + m_n) \bmod 100,000,007
\end{align}
