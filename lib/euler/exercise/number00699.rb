...
Define  T(N)  to be the sum of all numbers  n <= N  such that when the fraction  \frac{\sigma(n)}{n}  is written in its lowest form  \frac ab , the denominator is a power of 3 i.e.  b = 3^k, k > 0 .
